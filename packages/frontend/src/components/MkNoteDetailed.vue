		...
		<article :class="$style.note" @contextmenu.stop="onContextmenu">
			...
			<footer>
				<div :class="$style.noteFooterInfo">
					<button v-if="$appearNote.updatedAt" class="_button" :class="$style.editedButton" @click.stop="showEditHistory">
...
import { computed, defineAsyncComponent, inject, markRaw, provide, ref, useTemplateRef } from 'vue';
...
function showEditHistory() {
	os.popup(defineAsyncComponent(() => import('@/components/MkNoteEditHistoryDialog.vue')), {
		noteId: appearNote.id,
