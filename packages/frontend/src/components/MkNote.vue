...
>
	...
	<div v-if="isRenote" :class="$style.renote">
		...
		<MkAvatar :class="$style.renoteAvatar" :user="note.user" link preview @click.stop/>
		...
		<div :class="$style.renoteInfo">
			<button ref="renoteTime" :class="$style.renoteTime" class="_button" @mousedown.prevent="showRenoteMenu()" @click.stop>
	...
	<div v-else-if="renoteCollapsed" :class="$style.collapsedRenoteTarget">
		<MkAvatar :class="$style.collapsedRenoteTargetAvatar" :user="appearNote.user" link preview @click.stop/>
		<Mfm :text="getNoteSummary(appearNote)" :plain="true" :nowrap="true" :author="appearNote.user" :nyaize="'respect'" :class="$style.collapsedRenoteTargetText" @click="renoteCollapsed = false"/>
	</div>
	<article v-else :class="$style.article" @contextmenu.stop="onContextmenu">
		<div v-if="appearNote.channel" :class="$style.colorBar" :style="{ background: appearNote.channel.color }"></div>
		<MkAvatar :class="[$style.avatar, prefer.s.useStickyIcons ? $style.useSticky : null]" :user="appearNote.user" :link="!mock" :preview="!mock" @click.stop/>
		<div :class="$style.main">
			...
			<footer :class="$style.footer">
				...
				<button ref="reactButton" :class="$style.footerButton" class="_button" @click.stop="handleToggleReact()">
				...
				<button v-if="prefer.s.showClipButtonInNoteFooter" ref="clipButton" :class="$style.footerButton" class="_button" @mousedown.prevent="clip()" @click.stop>
...
function nav(ev: MouseEvent, to: string) {
	if (ev.shiftKey) {
		os.pageWindow(to);
		return;
	}

	router.pushByPath(to, ev.ctrlKey ? 'forcePage' : null);
}
